...
export const SOUNDS = [
  // ---- Nature -------------------------------------------------------------
  S('birds',              { file: 'birds.mp3',              category: 'nature', nameKey: 'birds',            glyph: 'bird',    color: '#7fb069', desc: 'Forest songbirds at dawn' }),
  S('tropical_birds',     { file: 'tropical-birds.mp3',     category: 'nature', nameKey: 'tropicalBirds',    glyph: 'bird',    color: '#e07a9a', desc: 'Exotic birds in a rainforest' }),
  S('jungle_birds',       { file: 'jungle-birds.mp3',       category: 'nature', nameKey: 'jungleBirds',      glyph: 'bird',    color: '#9ac46a', desc: 'Sparse jungle bird calls' }),
  S('campfire',           { file: 'campfire.mp3',           category: 'nature', nameKey: 'campfire',         glyph: 'flame',   color: '#ef8a5a', desc: 'Crackling fire' }),
  S('rain',               { file: 'rain.mp3',               category: 'nature', nameKey: 'rain',             glyph: 'drop',    color: '#8fb3ff', desc: 'Steady rain' }),
  S('thunder',            { file: 'thunder.mp3',            category: 'nature', nameKey: 'thunder',          glyph: 'bolt',    color: '#b48cff', desc: 'Rolling thunder' }),
  S('waves',              { file: 'waves.mp3',              category: 'nature', nameKey: 'waves',            glyph: 'waves',   color: '#4ea8de', desc: 'Gentle shore waves' }),
  ...
  S('jungle_river',       { file: 'jungle-river.mp3',       category: 'nature', nameKey: 'jungleRiver',      glyph: 'waves',   color: '#3aa6a0', desc: 'A river through the jungle' }),
  ...
  S('ocean_deep',         { file: 'ocean-deep.mp3',         category: 'nature', nameKey: 'oceanDeep',        glyph: 'waves',   color: '#2f7f9a', desc: 'Deep ocean ambience' }),
  ...
  G('bw_delta', { gen: 'binaural', spatial: false, params: { carrier: 200, beat: 2.5, bed: 0.25 }, category: 'frequencies', nameKey: 'bwDelta', glyph: 'wave', color: '#5b6cff', desc: 'Delta 2.5 Hz, deep sleep range', evidence: 'weak', band: 'delta' }),
  G('bw_theta', { gen: 'binaural', spatial: false, params: { carrier: 200, beat: 6,   bed: 0.25 }, category: 'frequencies', nameKey: 'bwTheta', glyph: 'wave', color: '#3fa7d6', desc: 'Theta 6 Hz, meditation range',  evidence: 'weak', band: 'theta' }),
  G('bw_alpha', { gen: 'binaural', spatial: false, params: { carrier: 200, beat: 10,  bed: 0.25 }, category: 'frequencies', nameKey: 'bwAlpha', glyph: 'wave', color: '#2ec4b6', desc: 'Alpha 10 Hz, relaxed focus', evidence: 'weak', band: 'alpha' }),
  G('bw_beta',  { gen: 'binaural', spatial: false, params: { carrier: 200, beat: 15,  bed: 0.25 }, category: 'frequencies', nameKey: 'bwBeta',  glyph: 'wave', color: '#7bd389', desc: 'Beta 15 Hz, active attention',   evidence: 'weak', band: 'beta' }),
  G('bw_gamma', { gen: 'binaural', spatial: false, params: { carrier: 200, beat: 40,  bed: 0.25 }, category: 'frequencies', nameKey: 'bwGamma', glyph: 'wave', color: '#f4a261', desc: 'Gamma 40 Hz',                    evidence: 'weak', band: 'gamma' }),
  G('iso_alpha', { gen: 'isochronic', params: { freq: 220, beat: 10, duty: 0.5 }, category: 'frequencies', nameKey: 'isoAlpha', glyph: 'pulse', color: '#2ec4b6', desc: 'Pulsed tone, 10 Hz. Works on speakers.', evidence: 'weak', band: 'alpha' }),
  G('iso_theta', { gen: 'isochronic', params: { freq: 180, beat: 6,  duty: 0.5 }, category: 'frequencies', nameKey: 'isoTheta', glyph: 'pulse', color: '#3fa7d6', desc: 'Pulsed tone, 6 Hz',  evidence: 'weak', band: 'theta' }),
  G('iso_gamma', { gen: 'isochronic', params: { freq: 240, beat: 40, duty: 0.5 }, category: 'frequencies', nameKey: 'isoGamma', glyph: 'pulse', color: '#f4a261', desc: 'Pulsed tone, 40 Hz', evidence: 'weak', band: 'gamma' }),
  G('mono_alpha', { gen: 'monaural', params: { carrier: 200, beat: 10 }, category: 'frequencies', nameKey: 'monoAlpha', glyph: 'pulse', color: '#59c3a5', desc: 'Two tones beating in the air, 10 Hz', evidence: 'weak', band: 'alpha' }),
  G('tone_pure',      { gen: 'tone', params: { freq: 432, harmonics: 0.15, vibrato: 0 }, category: 'frequencies', nameKey: 'tonePure',      glyph: 'tone',  color: '#e9c46a', desc: 'Sine tone, any frequency', evidence: 'none' }),
  G('tone_solfeggio', { gen: 'tone', params: { freq: 528, harmonics: 0.2,  vibrato: 0.3 }, category: 'frequencies', nameKey: 'toneSolfeggio', glyph: 'tone',  color: '#f2cc8f', desc: 'Solfeggio scale, 174 to 963 Hz', evidence: 'none' }),
  G('schumann',       { gen: 'schumann', params: { carrier: 136.1, beat: 7.83, depth: 0.8 }, category: 'frequencies', nameKey: 'schumann', glyph: 'drone', color: '#8ab17d', desc: 'Low tone pulsing at 7.83 Hz', evidence: 'none' }),
  G('noise_white', { gen: 'noise', params: { color: 'white', cutoff: 12000 }, category: 'frequencies', nameKey: 'noiseWhite', glyph: 'noise', color: '#d0d0d0', desc: 'Flat spectrum, masks speech', evidence: 'moderate' }),
  G('noise_pink',  { gen: 'noise', params: { color: 'pink',  cutoff: 12000 }, category: 'frequencies', nameKey: 'noisePink',  glyph: 'noise', color: '#f4a3c2', desc: 'Softer, like steady rain',   evidence: 'moderate' }),
  // No noise-colour trial covers brown specifically; only white and pink.
  G('noise_brown', { gen: 'noise', params: { color: 'brown', cutoff: 8000 },  category: 'frequencies', nameKey: 'noiseBrown', glyph: 'noise', color: '#b07d62', desc: 'Deep rumble, like a waterfall', evidence: 'weak' }),
  // A pacing cue belongs to the listener, not to a point in the room.
  G('breath', { gen: 'breath', spatial: false, params: { bpm: 6, inhale: 0.45, tone: 0.5 }, category: 'frequencies', nameKey: 'breath', glyph: 'breath', color: '#94d2bd', desc: 'Breathing pacer, 6 breaths per minute', evidence: 'moderate' }),
